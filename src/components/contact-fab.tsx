...
/**
 * Floating call / WhatsApp buttons. Most of this agency's enquiries already
 * arrive by phone and DM, so these stay reachable on every page — especially
 * on mobile, where the header CTA scrolls away.
 */
  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 flex flex-col gap-2.5 print:hidden">
      ...
      <a
        ...
        title={callLabel}
        className="flex h-13 w-13 items-center justify-center rounded-full bg-ocean-800 p-3.5 text-white shadow-lift transition hover:scale-105 active:scale-95 sm:hidden"
      >
        <svg viewBox="0 0 24 24" aria-hidden="true" className="h-full w-full fill-current">
          <path d="M6.6 10.8a15.1 15.1 0 0 0 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.4.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1C10.6 21 3 13.4 3 4c0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.4 0 .7-.2 1l-2.3 2.2Z" />
        </svg>
      </a>
    </div>
  );
